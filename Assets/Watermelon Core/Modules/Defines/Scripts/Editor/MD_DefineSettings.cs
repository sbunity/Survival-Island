namespace Watermelon
{
    public static class DefineSettings
    {
        public static readonly RegisteredDefine[] STATIC_REGISTERED_DEFINES = new RegisteredDefine[]
        {
            ...
            // Core
            new RegisteredDefine("MODULE_MONETIZATION", "Watermelon.Monetization", "Modules/Monetization/Scripts/MonetizationSDKBehavior.cs"),
            new RegisteredDefine("MODULE_POWERUPS", "Watermelon.PUController", "Scripts/PUController.cs"),
            new RegisteredDefine("MODULE_HAPTIC", "Watermelon.Haptic", "Scripts/Haptic.cs"),
        };
    }
}