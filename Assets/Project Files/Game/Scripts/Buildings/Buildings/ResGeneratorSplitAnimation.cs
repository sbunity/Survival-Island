...
namespace Watermelon
{
    public class ResGeneratorSplitAnimation : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            Currency currency = CurrencyController.GetCurrency(generatorRef.ResourceType);
            CurrencyData currencyData = currency.Data;

            flyingResTransform1 = currencyData.FlyingResPool.GetPooledObject().transform;
            flyingResTransform2 = currencyData.FlyingResPool.GetPooledObject().transform;
