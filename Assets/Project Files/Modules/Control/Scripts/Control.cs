...
namespace Watermelon
{
    public static class Control
    {
        ...
        private static GameObject ownerObject;

        public static bool IsInitialized { get; private set; } = false;

        public static void Init(InputType inputType, GamepadData gamepadData, GameObject owner)
        {
            ownerObject = owner;
        ...
        public static void ChangeInputType(InputType inputType)
        {
            ...
            switch (inputType)
            {
                case InputType.Gamepad:
                    ...
                    GamepadControl gamepadControl = ownerObject.AddComponent<GamepadControl>();
                    gamepadControl.Init();
                ...
                case InputType.Keyboard:
                    KeyboardControl keyboardControl = ownerObject.AddComponent<KeyboardControl>();
